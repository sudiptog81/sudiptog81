...
export default () => ({
  ...
  technologies: {
    "languages": [ "C", "C++", "Python", "Java", "C#", "JavaScript", "TypeScript", "Go", "Dart", "Rust", "Bash", "YAML", "SQL", "HTML", "CSS", "PHP", "x86 Assembly" ],
    "web": [ "Django", "Flask", "React", "Angular", "Vue.js", "Express.js", "Node.js", "Deno", "jQuery", "Leaflet", "WebPack", "Babel", "Axios", "Bootstrap", "Materialize CSS", "WordPress", "Drupal", "Spring MVC", "ASP.NET Core", "ASP.NET MVC" ],
    "databases": [ "PostgreSQL", "MariaDB/MySQL", "TSQL", "PL/SQL", "IBM DB2", "MongoDB", "Cloud Firestore", "Cassandra", "Memcached", "ElasticSearch", "Redis", "SQLite" ],
